...
export default function PortfolioPage() {
	...
	return (
		<div className="theme-shell min-h-screen montserrat" style={{ color: "var(--text-primary)" }}>
			<Seo
				title="Portfolio"
			...
			<section className="relative pt-32 pb-16 px-6 overflow-hidden">
				...
				<div
					...
					style={{ background: "var(--glow-orb-2)" }}
				/>
				...
				<div className="max-w-7xl mx-auto relative z-10">
					<div className="text-center max-w-4xl mx-auto">
						...
						<h1
							className="text-5xl md:text-6xl font-semibold mb-6 leading-tight raleway text-balance"
			...
			<section
				className="py-8 px-6 border-b sticky top-[73px] z-40 backdrop-blur-xl"
				style={{
					borderColor: "var(--sticky-bar-border)",
						...
						{filters.map((filter) => (
							<button
								...
								className={`px-6 py-2 rounded-full font-medium transition border ${
									activeFilter === filter.id ? "accent-button" : ""
								}`}
								style={
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						{filteredProjects.map((project, index) => (
							<div
								key={project.id}
								className="group rounded-2xl overflow-hidden border shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
								style={{
									borderColor: "var(--border-soft)",
							...
							>
								<div className="relative h-64 overflow-hidden">
									<div
										className={`absolute inset-0 bg-linear-to-br ${project.color} opacity-0 group-hover:opacity-95 transition-opacity duration-500 z-10 flex items-center justify-center`}
									>
			...
			<section className="py-20 px-6" style={{ background: "var(--portfolio-approach-bg)" }}>
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid md:grid-cols-4 gap-8">
						{[
							...
							<div key={item.title} className="text-center surface-panel rounded-2xl p-8">
								...
								<div className="leading-7" style={{ color: "var(--text-secondary)" }}>
									{item.copy}
								</div>
							</div>
						))}
			...
			<section className="py-20 px-6">
				<div className="max-w-4xl mx-auto text-center">
					<div className="surface-panel rounded-3xl p-12">
						...
						<Link
							to="/#contact"
							className="inline-flex items-center accent-button px-8 py-4 rounded-full font-semibold transition"
						>
							Start Your Project
						</Link>
					</div>
